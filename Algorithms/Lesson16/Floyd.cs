...
public class Floyd
{
    ...
    public static void Run()
    {
        using var reader = new StreamReader(new FileStream(
            @"D:\Code\CS\DataStructuresAndAlgorithms\Algorithms\Lesson\Lesson16\Floyd-input.txt", FileMode.Open));
        using var writer = new StreamWriter(new FileStream(
            @"D:\Code\CS\DataStructuresAndAlgorithms\Algorithms\Lesson\Lesson16\Floyd-output.txt",
