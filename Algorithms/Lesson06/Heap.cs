...
public class Heap
{
    public static void Run()
    {
        ...
        var myMaxHeap = new MyMaxHeap(10);
        myMaxHeap.Push(4);
        myMaxHeap.Push(3);
        myMaxHeap.Push(2);
        myMaxHeap.Push(1);
        ...
        myMaxHeap.Push(6);
        myMaxHeap.Push(5);
        while (!myMaxHeap.IsEmpty()) Console.WriteLine(myMaxHeap.Pop());

        Console.WriteLine("小根堆");
        var myMinHeap = new MyMinHeap(10);
        myMinHeap.Push(4);
        myMinHeap.Push(3);
        myMinHeap.Push(2);
        myMinHeap.Push(1);
        ...
        while (!myMinHeap.IsEmpty()) Console.WriteLine(myMinHeap.Pop());
        ...
        for (var i = 0; i < testTimes; i++)
        {
            ...
            {
                if (my.IsEmpty() != test.IsEmpty()) Console.WriteLine("出错啦！");

                if (my.IsFull() != test.IsFull()) Console.WriteLine("出错啦！");
                ...
                {
                    if (my.Pop() != test.Pop()) Console.WriteLine("出错啦！");
                }
                else
                {
    ...
    public class MyComparator : IComparable<int>
    {
